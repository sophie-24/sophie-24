...
- 🎯 지금 향하고 있는 목표: **백엔드 엔지니어** — API를 붙여 빠르게 띄우는 것을 넘어, 데이터가 생성·저장·가공되어 가치로 이어지는 흐름 자체를 설계하고 싶습니다. 또한 "근거 있는 개발"을 추구합니다.
- 🤝 많은 프로젝트에서 팀장 / 개발리드 / 커뮤니케이션 허브를 맡으며 협업과 소통을 우선순위에 둡니다. 팔로워로서의 프로젝트 참여도 또한 높다는 평가를 자주 받습니다.
...
| ReviewTrace | PR 리뷰 댓글 속 기술 부채 신호 수집·분류·추적 개인 사이드 프로젝트 |
| CoELA 기반 다중 로봇 협력 시스템 | 동국대학교 개별연구
